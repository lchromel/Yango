...
- `GEMINI_API_KEY` (редактирование изображения и 3D-стиль через Nano Banana 2 / Gemini image)
...
- сгенерировать изображение после нажатия `GENERATE`
- выбрать стиль `3D`, описать объект и получить GPT-оптимизированный промт с генерацией через Nano Banana 2
